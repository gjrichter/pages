...
(function() {
	...
	ixmaps.pinnacleChart = function(SVGDocument,args){
		...
		var szTitleColor = args.theme.szTextColor || "444444";
		...
		if ( args.flag.match(/VALUES/) ){
			...
			if ( nFontSize > (args.theme.nValueSizeMin||120) ){
				var szText = ixmaps.__formatValue(nValue,0,"SPACE") + " " + (args.theme.szUnits||"");
				var szTextOpacity = 1; // 0.2 + nValue/nMax;

				// show the value on top of the peek
				svg.append("text")
					.attr("x", 0)
					.attr("y", -rad-nFontSize*0.6)
				...
				svg.append("text")
					.attr("x", 0)
					.attr("y", -rad-nFontSize*0.6)
					.attr("style","font-family:arial;font-size:"+nFontSize+"px;text-anchor:middle;fill:"+szColor+";fill-opacity:"+szTextOpacity+";stroke:none;opacity:"+szOpacity+";pointer-events:none")
					.text(szText);
				...
				if (args.item.szTitle){
					...
					svg.append("text")
						.attr("x", 0)
						.attr("y", -rad-nFontSize*0.3)
						.attr("style","font-family:arial;font-size:"+nFontSize+"px;text-anchor:middle;fill:"+szTitleColor+";fill-opacity:"+szTextOpacity+";stroke:none;opacity:"+szOpacity+";pointer-events:none")
						.text(args.item.szTitle);
				}
			}
		}
