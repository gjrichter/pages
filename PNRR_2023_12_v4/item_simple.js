			...
			if (data) {
				...
				for (d = 0; d < Math.min(50, data.length); d++) {
					...
					for (i in dataObject) {
						...
						var szValue = (isNaN(value) || !value ) ? "<span style='font-size:0.8em'>"+String(value)+"</span>" : (ixmaps.__formatValue?ixmaps.__formatValue(value,2,"BLANK"):value.toFixed(themeObj.nValueDecimals||2)) + " " + themeObj.szUnits;
