			...
			if (data) {
				...
				for (d = 0; d < Math.min(50, data.length); d++) {
					...
					for (i in dataObject) {
						...
						if (!(i == "Sintesi progetto" || i == "importo" || i == "pop_2022" || i == "importo_procapite" || i == "CUP" || i == "CIG" || i == "Descrizione Submisura" || i == "Soggetto attuatore" || i == "Denominazione Aggiudicatario")){
							//continue;
						}
						...
						if ( i == "importo" ){
							szValue = " " + szValue + "€ finanziamento totale";
						}else
